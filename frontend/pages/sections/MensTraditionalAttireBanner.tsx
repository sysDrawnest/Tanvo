...
const NewArrivalsBanner: React.FC = () => {
    return (
        <section className="relative w-full bg-[#F9F5EE] px-4 md:px-12 lg:px-16 py-12 md:py-20 lg:py-24 z-20">
            {/* Main Box Card */}
            <div className="relative w-full max-w-7xl mx-auto rounded-none overflow-visible min-h-[380px] sm:min-h-[440px] md:min-h-[580px] lg:min-h-[640px] shadow-[0_25px_60px_-15px_rgba(0,0,0,0.2)] bg-[#0F0D0C]">
